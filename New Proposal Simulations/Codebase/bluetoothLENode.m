classdef bluetoothLENode < comm.internal.ConfigBase & wirelessnetwork.internal.wirelessNode
...
methods
    % Constructor
    function obj = bluetoothLENode(role, varargin)
        ...
        % Validate the role
        obj.Role = validatestring(role, bluetoothLENode.Role_Values, mfilename, "role", 1);
        ...
        switch obj.Role
            case {"central", "peripheral"}
                obj.pLinkLayer = ble.internal.linkLayerConnections(notificationFcn,Role=obj.Role);
