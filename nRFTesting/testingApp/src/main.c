...
#define SUPERVISION_TIMEOUT 3000
...
static struct device_role devices[NUMBER_DEVICES] = {{{0x8e,0x0c,0x08,0xbc,0x82,0xa5,0x0a,0xcd}, PERIPHERAL}, // The hardware address of the device used as peripheral
												 {{0xbf,0x4b,0xec,0xaa,0xaa,0x12,0x83,0xe3}, CENTRAL}, // The hardware address of the device used as central
												};
